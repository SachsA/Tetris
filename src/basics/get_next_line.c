/*
** get_next_line.c for get_next_line in /home/sachs_a/delivery/get_next_line
** 
** Made by Alexandre Sachs
** Login   <sachs_a@epitech.net>
** 
** Started on  Fri Dec 30 15:25:57 2016 Alexandre Sachs
** Last update Sat Mar 18 17:19:28 2017 Alexandre Sachs
*/
...
char			*my_addline(char *buffer, char *new_line, int *pos, int comp)
{
  int			i;
  int			j;
  char			*str;
